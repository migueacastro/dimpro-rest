...
{:else}  
	<div class="lg:flex lg:flex-row ml-[3.5rem] mt-5">
		<a class="block card card-hover lg:p-[3.75rem] p-[1.5rem] mx-auto lg:my-auto my-5 dark:variant-filled-surface variant-filled-tertiary" href="/dashboard/add-order">
			<div class="flex flex-row">
				<p class="font-bold h4">Crear Pedido</p>
				<i class="fa-solid fa-plus h3 ml-5" />
			</div>
		</a>
		<a class="block card card-hover lg:p-[3.75rem] p-[1.5rem] mx-auto lg:my-auto my-5 dark:variant-filled-surface variant-filled-tertiary" href="/dashboard/edit-order">
			<div class="flex flex-row">
